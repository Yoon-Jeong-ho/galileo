...
- **Page-counting hygiene (2026-02-20):** LaTeX SSOT now has an explicit `\ifreview` toggle to build with/without EMNLP review mode (line numbers). Use `\reviewfalse` for closer-to-submission page budgeting.
