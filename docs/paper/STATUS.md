...
- **Main-text expansion tracking (2026-02-20):** after Intro + Protocol notation + Results narrative expansion (Survival/Fail@1/Recovery/Cross-family), camera-ready budget is now main(excl Limitations)=4 pages (target: 8).
