...
- **Tier‑1 Qwen2.5‑14B‑Instruct (cross-family extension):**
  ...
  - seed2 is **running** on nlp8 GPU5: `results/tier1_qwen2p5_14b_seed2_20260219_053824/` (as of 06:44 KST: entered recovery (73 cases) and then appears to start a **second adversarial-testing block**; still no exports yet).
...
- ✅ Canonical cross-family figure filename (anti-drift): `docs/paper/figures/cross_family_survival_r5_control_vs_logicaltrap_seed1-2_20260218.svg`
