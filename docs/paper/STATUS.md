...
- **Main-text expansion tracking (2026-02-20):** after Intro + Protocol notation + early Results narrative expansion, camera-ready budget is now main(excl Limitations)=4 pages (target: 8).
