...
- ✅ Related Work §6.4 now explicitly frames NRC as the missing “evidence-free, matched-length” counterfactual that separates pressure mechanisms from generic drift / evaluation framing confounds (positioning vs TRUTH DECAY / Challenging the Evaluator): `docs/paper/PAPER_DRAFT_EN.md`.
