...
- **Remote sanity (2026-02-22 04:09 KST):** GPU3 is currently occupied by **aa007878** (`Training/train_llama.py` for PrivacyRestore; ~19.6GiB). GPUs 0/1/2/4/5/6 appear idle. Avoid launching GALILEO on GPU3 until that job finishes.
