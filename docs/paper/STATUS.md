...
- **Decoding sweep (seed1) done:** `results_paper/qwen_temp0_seed1` + `results_paper/qwen_temp0p7_seed1` are paper-ready; `results_paper/GLOBAL_VALIDATE.log` remains all `[OK]`.
