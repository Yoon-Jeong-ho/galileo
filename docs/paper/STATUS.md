...
- ✅ **Tier‑1 cross-family extension:** `meta-llama/Llama-3.2-3B-Instruct` **seed1** is now auditable green (fixed missing `runner_metadata.json`) and staged under `results_paper/tier1_llama3_3b_seed1_20260212_030426/`.
