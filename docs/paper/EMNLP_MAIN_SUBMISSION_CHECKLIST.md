...
---|---|---|---
C1 (Dynamics): failures are multi-turn trajectories; survival/TOF needed beyond initial accuracy. | `docs/paper/figures/survival_curves_rounds_seed1-4_20260209.svg` (primary) | `docs/paper/artifacts/survival_curve_personawise_control_vs_persona_seed1-4_mean_std_20260209.csv`; `docs/paper/artifacts/tof_personawise_fail1_never_control_vs_persona_seed1-4_mean_std_20260209.csv` | nlp8: `python3 scripts/validate_paper_exports.py --results_root results_paper --check_runner_parity` (PASS in `results_paper/GLOBAL_VALIDATE.log`); runs: `results_paper/qwen_control_seed{1..4}`, `results_paper/qwen_persona_seed{1..4}`
C2 (Mechanism vs drift): persona pressure causes effects beyond generic drift; control baseline is essential. | `docs/paper/figures/table_w_effect_delta_seed1-4_20260209.svg` | `docs/paper/artifacts/table_w_effect_delta_seed1-4_20260209.csv` | generator: `scripts/make_table_w_control_vs_persona.py --control_persona_id neutral_reask_control --round 5`; paper-ready runs: `results_paper/qwen_control_seed{1..4}`, `results_paper/qwen_persona_seed{1..4}`
C3 (Robustness vs recovery): recovery is **conditional on flip** (return-to-truth after an example has flipped) and is distinct from robustness (staying correct throughout). | `docs/paper/figures/recovery_personawise_delta_seed1-4_20260209.svg` | `docs/paper/artifacts/recovery_personawise_control_vs_persona_seed1-4_mean_std_20260209.csv`; `docs/paper/artifacts/recovery_collapsed_control_vs_persona_seed1-4_mean_std_20260209.csv` | nlp8 (paper SSOT): `python3 scripts/validate_paper_exports.py --results_root results_paper --check_runner_parity` (see `results_paper/GLOBAL_VALIDATE.log`); runs: `results_paper/qwen_control_seed{1..4}`, `results_paper/qwen_persona_seed{1..4}`
Generalization: effects replicate across model families under the same protocol. | `docs/paper/PAPER_DRAFT_EN.md` §7.4 (cross-family) | `docs/paper/artifacts/tier1_mistral7b_seed1-2_survival_summary_20260210.csv`; `docs/paper/artifacts/tier1_llama3_8b_seed1-2_survival_summary_20260210.csv` | paper-ready runs: `results_paper/mistral_seed{1,2}`, `results_paper/llama_seed{1,2}`; validate with `scripts/validate_paper_exports.py --results_root results_paper --check_runner_parity`
Intervention ablation: recovery prompt variant changes recovery dynamics but does not remove robustness drops. | `docs/paper/PAPER_DRAFT_EN.md` §7.4 (verify_then_answer) | `docs/paper/artifacts/tier1_qwen2p5_7b_vta_seed1-2_survival_summary_20260210.csv`; `docs/paper/artifacts/tier1_qwen2p5_7b_vta_seed1-2_recovery_collapsed_20260210.csv` | paper-ready runs: `results_paper/qwen_vta_seed{1,2}`; validate with `scripts/validate_paper_exports.py --results_root results_paper --check_runner_parity`
Robustness (appendix): decoding sensitivity (temp 0.0 vs 0.7) does not qualitatively change persona–control gaps. | `docs/paper/PAPER_DRAFT_EN.md` Appendix A.1; Fig.~`fig:decoding-sweep` | `docs/paper/artifacts/decoding_sweep_qwen_temp_summary_seed1-2_20260211.csv` | paper-ready runs: `results_paper/qwen_temp0_seed{1,2}`, `results_paper/qwen_temp0p7_seed{1,2}`; validate with `scripts/validate_paper_exports.py --results_root results_paper --check_runner_parity`
