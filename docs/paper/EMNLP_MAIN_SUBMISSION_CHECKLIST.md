...
---|---|---|---
C1 (Dynamics): failures are multi-turn trajectories; survival/TOF needed beyond initial accuracy. | `docs/paper/figures/survival_curves_rounds_seed1-4_20260209.svg` + `docs/paper/figures/tof_personawise_fail1_delta_seed1-4_20260209.svg` | `docs/paper/artifacts/survival_curve_personawise_control_vs_persona_seed1-4_mean_std_20260209.csv`; `docs/paper/artifacts/tof_personawise_fail1_never_control_vs_persona_seed1-4_mean_std_20260209.csv` | nlp8 `results_paper/qwen_control_seed1..4` + `results_paper/qwen_persona_seed1..4` (validated; see `results_paper/GLOBAL_VALIDATE.log`)
C2 (Mechanism vs drift): persona pressure causes effects beyond generic drift; control baseline is essential. | `docs/paper/figures/table_w_effect_delta_seed1-4_20260209.svg` | `docs/paper/artifacts/table_w_effect_delta_seed1-4_20260209.csv` | `scripts/make_table_w_control_vs_persona.py` + nlp8 `results_paper/qwen_control_seed1..4` + `results_paper/qwen_persona_seed1..4`
C3 (Robustness vs recovery): recovery is a distinct axis from “staying correct”; measured conditional on flip. | `docs/paper/figures/recovery_personawise_delta_seed1-4_20260209.svg` | `docs/paper/artifacts/recovery_personawise_control_vs_persona_seed1-4_mean_std_20260209.csv`; `docs/paper/artifacts/recovery_collapsed_control_vs_persona_seed1-4_mean_std_20260209.csv` | per-run `recovery_accuracy.csv` + nlp8 `results_paper/qwen_control_seed1..4` + `results_paper/qwen_persona_seed1..4`
Generalization: effects replicate across model families under the same protocol. | (text + small table) see cross-family survival summaries in draft | `docs/paper/artifacts/tier1_mistral7b_seed1-2_survival_summary_20260210.csv`; `docs/paper/artifacts/tier1_llama3_8b_seed1-2_survival_summary_20260210.csv` | nlp8 `results_paper/mistral_seed1/2` + `results_paper/llama_seed1/2`
Intervention ablation: recovery prompt variant changes recovery dynamics but does not remove robustness drops. | (text) verify_then_answer ablation paragraph | `docs/paper/artifacts/tier1_qwen2p5_7b_vta_seed1-2_survival_summary_20260210.csv`; `docs/paper/artifacts/tier1_qwen2p5_7b_vta_seed1-2_recovery_collapsed_20260210.csv` | nlp8 `results_paper/qwen_vta_seed1/2`
