...
C3 (Robustness vs recovery): recovery is **conditional on flip** (return-to-truth after an example has flipped) and is distinct from robustness (staying correct throughout). | `docs/paper/figures/recovery_personawise_delta_seed1-4_20260209.svg` | `docs/paper/artifacts/recovery_personawise_control_vs_persona_seed1-4_mean_std_20260209.csv`; `docs/paper/artifacts/recovery_collapsed_control_vs_persona_seed1-4_mean_std_20260209.csv` | per-run: `results_paper/**/recovery_accuracy.csv` (or `results/**/recovery_accuracy.csv`); validator: `scripts/validate_paper_exports.py`; runs: `results_paper/qwen_control_seed{1..4}`, `results_paper/qwen_persona_seed{1..4}`
Generalization: effects replicate across model families under the same protocol. | (text) cross-family survival summaries | `docs/paper/artifacts/tier1_mistral7b_seed1-2_survival_summary_20260210.csv`; `docs/paper/artifacts/tier1_llama3_8b_seed1-2_survival_summary_20260210.csv` | paper-ready runs: `results_paper/mistral_seed{1,2}`, `results_paper/llama_seed{1,2}` (+ global parity PASS)
Intervention ablation: recovery prompt variant changes recovery dynamics but does not remove robustness drops. | (text) verify_then_answer ablation paragraph | `docs/paper/artifacts/tier1_qwen2p5_7b_vta_seed1-2_survival_summary_20260210.csv`; `docs/paper/artifacts/tier1_qwen2p5_7b_vta_seed1-2_recovery_collapsed_20260210.csv` | paper-ready runs: `results_paper/qwen_vta_seed{1,2}`; validator parity PASS
