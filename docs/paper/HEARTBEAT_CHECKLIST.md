...
## B) If lane = Experiments (nlp8 only)
...
- Add/upgrade **one vault note** in `docs/paper/related_work/papers/*.md` to include protocol + metrics + how it affects our paper.
- Add at least **one concrete citation sentence** to `docs/paper/PAPER_DRAFT_EN.md`.
