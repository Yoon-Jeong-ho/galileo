...
- **Control condition**: the **Neutral Re-asking Control (NRC)** (a non-persona multi-turn drift baseline; repeated *neutral* re-check requests with **no new evidence**) to show effects are not purely conversational drift.
