...
Concretely, Phi-3-mini also shows a sizeable gap under the same protocol (seeds 1–2: Neutral Re-asking Control **Survival@5 = 25.22%±7.85**, Logical Trap **Survival@5 = 9.16%±1.36**; tracked artifact `docs/paper/artifacts/tier1_phi3mini_seed1-2_survival_summary_20260217.csv`). Mistral-Nemo-Instruct-2407 exhibits the same qualitative separation (seeds 1–2: Neutral Re-asking Control **Survival@5 = 32.54%±4.77**, Logical Trap **Survival@5 = 9.29%±0.44**; tracked artifact `docs/paper/artifacts/tier1_mistralnemo_seed1-2_survival_summary_20260217.csv`).
