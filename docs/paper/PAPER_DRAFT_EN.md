...
**Seed-1 snapshot (Qwen2.5-7B-Instruct, 80 samples, nlp8; auditable green).**
- Control root: `results/c2run_control_20260209_172640/`
- Persona root: `results/c2run_persona_20260209_174640/`
- Generated by: `scripts/make_table_w_control_vs_persona.py --control_persona_id neutral_reask_control --round 5`

Metric | Control (Neutral Re-asking Control) | Persona pressure (weighted) | Persona pressure (unweighted)
---|---:|---:|---:
