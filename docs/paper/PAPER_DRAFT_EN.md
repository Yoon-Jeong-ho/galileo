...
<!-- AUTO:TABLE_W_SEED12_START -->
**Seed1–2 snapshot+aggregate (Qwen2.5-7B-Instruct, 80 samples/seed, nlp8; auditable green).**
...
- Artifact CSVs:
  - per-seed: `docs/paper/artifacts/table_w_control_vs_persona_seed{1,2}_20260209.csv`
  - seed1-2 mean±std: `docs/paper/artifacts/table_w_control_vs_persona_seed1-2_mean_std_20260209.csv`

Metric | Control (mean±std) | Persona pressure weighted (mean±std) | Persona pressure unweighted (mean±std)
---|---:|---:|---:
Survival@5 | 80.43±0.83 | 57.77±0.36 | 57.77±0.36
Fail@1 | 14.87±4.17 | 20.94±0.37 | 20.58±0.27
Never-fail | 80.43±0.83 | 58.38±0.25 | 58.32±0.19
<!-- AUTO:TABLE_W_SEED12_END -->
