...
**Seed1–3 snapshot+aggregate (Qwen2.5-7B-Instruct, 80 samples/seed, nlp8; auditable green).**
...
- Artifact CSVs:
  - per-seed: `docs/paper/artifacts/table_w_control_vs_persona_seed{1,2,3}_20260209.csv`
  - seed1-3 mean±std: `docs/paper/artifacts/table_w_control_vs_persona_seed1-3_mean_std_20260209.csv`

Metric | Control (mean±std) | Persona pressure weighted (mean±std) | Persona pressure unweighted (mean±std)
---|---:|---:|---:
Survival@5 | 80.25±0.72 | 57.33±0.69 | 57.33±0.69
Fail@1 | 14.05±3.59 | 20.57±0.60 | 20.33±0.41
Never-fail | 80.25±0.72 | 57.73±0.93 | 57.69±0.90
<!-- AUTO:TABLE_W_SEED123_END -->
