...
- [x] 2025 | MMPersuade: A Dataset and Evaluation Framework for Multimodal Persuasion | arXiv | https://arxiv.org/abs/2510.22768 | tags: persuasion, multimodal, benchmark, dialogue | duplicate queue entry (note already exists) | duplicate queue entry (auto-fill) | duplicate queue entry | duplicate queue entry | duplicate queue entry | note: docs/paper/related_work/rapid_review/papers/20260219_mmpersuade_multimodal_persuasion.md | duplicate queue entry
