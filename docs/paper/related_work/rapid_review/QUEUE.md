...
- [x] 2025 | When Two LLMs Debate, Both Think They’ll Win | arXiv | https://arxiv.org/abs/2505.19184 | tags: multi-turn, debate, belief-revision, confidence, persuasion | duplicate queue entry (already reviewed) | duplicate queue entry (already reviewed) | note: docs/paper/related_work/rapid_review/papers/20260217_two-llms-debate-win.md | duplicate queue entry
